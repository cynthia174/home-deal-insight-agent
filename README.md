...
| 完整数据工作台 | 首页展开原表预览，并可在独立页面搜索、筛选、排序和下载全部明细 |
...
首页可展开前 50 条原始数据预览，也可以在独立页面打开全部 720 条明细。完整页面支持全表搜索、五类组合筛选、列排序、横纵滚动和结果下载。

<img src="docs/images/data-table-workbench.png" alt="完整数据表工作台" width="520">
